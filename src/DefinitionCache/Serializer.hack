...
class HTMLPurifier_DefinitionCache_Serializer {
    ...
    public function generateKey(HTMLPurifier\HTMLPurifier_Config$config): string {
        ...
        return $config->version . ',' . // possibly replace with function calls
               (string)$config->getBatchSerial($this->type) . ',' . (string)$type_rev;
    }
     ...
     * @return int|bool
     */
    public function add(HTMLPurifier\HTMLPurifier_Definition $def, 
        HTMLPurifier\HTMLPurifier_Config $config) : int {
